...
def train(X_train, y_train, epoch_num, batch_size, model_type,model_config=None):
    if model_type == 'sequential':
        ...
        history = model.fit(X_train,Y_train,epochs=epoch_num,batch_size=batch_size,verbose=1,callbacks=[checkpoint_callback])  
